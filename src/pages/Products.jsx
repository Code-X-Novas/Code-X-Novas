...
const Products = () => {
  ...
  return (
    <section className="relative w-full py-11 sm:py-6 px-6 md:px-12 bg-white text-center overflow-hidden">
      ...
      <div className="hidden sm:flex items-center justify-center max-w-6xl mx-auto relative">
        <DesktopProducts
          index={index}
          direction={direction}
      ...
      {/* Mobile */}
      <div className="flex sm:hidden items-center justify-center max-w-md mx-auto relative">
        <MobileProducts
          index={index}
          direction={direction}
          handlePrev={handlePrev}
