...
const Careers = () => {
  return (
    <section className="relative w-full py-20 px-6 md:px-12 bg-gradient-to-b from-[#fdfdfd] to-[#f5f9ff] text-center overflow-hidden">
      ...
      <h2
        className="text-3xl sm:text-4xl md:text-4xl font-bold mb-3 relative z-10"
        style={{ fontFamily: "Sora" }}
      >
        <span className="text-black">Join Our Product </span>
        <span className="text-blue-600">Team / Careers</span>
      </h2>
      <p className="text-black mb-12 text-lg relative z-10">
      ...
      <div className="flex justify-center relative z-10">
        <button className="relative flex items-center overflow-hidden rounded-md transition-all group">
          ...
          <span className="relative z-10 pr-6 font-medium text-gray-800 group-hover:text-white transition-all duration-300">
