...
const LegalPage = () => {
  ...
  return (
    <section className="mx-auto py-12 px-5 sm:px-12 text-gray-800">
      {/* Header */}
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center p-4 rounded-full bg-blue-100 text-blue-600 mb-4">
          {isPrivacy ? (
            <FiShield size={36} />
          ) : isTerms ? (
            <FiFileText size={36} />
        ...
        <p className="mt-2 text-gray-500">Last Updated: October 2025</p>
      </div>
      ...
      <div className="space-y-6 leading-relaxed text-[1.05rem]">
        {isPrivacy && (
          <>
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700">
              <FiLock /> 1. Information We Collect
            </div>
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiCheckCircle /> 2. How We Use Your Information
            </div>
            <ul className="list-disc ml-6 space-y-2 mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiFileText /> 7. Updates to This Policy
            </div>
            <p className="mb-4">
        ...
        {isTerms && (
          <>
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiCheckCircle /> 1. Acceptance of Terms
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiShield /> 3. Intellectual Property
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiDatabase /> 4. Payments and Pricing
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiInfo /> 5. Client Responsibilities
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiAlertCircle /> 6. Limitation of Liability
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiGlobe /> 7. Third-Party Services
            </div>
            <p className="mb-4">
            ...
            <div className="flex items-center gap-2 text-xl font-semibold text-blue-700 mt-4">
              <FiCheckCircle /> 10. Governing Law
            </div>
            <p className="mb-4">
        ...
        {!isPrivacy && !isTerms && (
          <div className="text-center text-gray-600">
            <FiInfo className="inline-block text-2xl text-blue-500 mb-2" />
            <p className="mb-2">
